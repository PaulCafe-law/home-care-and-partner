...
import './calendartoschedule-med.css';
...
const CalendarToScheduleMed = (handleCurrentPageChange) =>{
    ...
    return(
        <div>
            ...
            <div className="body">
                ...
                <Link to="/schedulemed" className="link-no-underline">
                    <Calendar 
...
export default CalendarToScheduleMed;